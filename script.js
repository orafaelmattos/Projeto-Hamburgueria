...
//Botão de Fechar para fechar o modal
closeModalBtn.addEventListener("click", function(){
    cartModal.style.display = "none"
})

//Pegar o item que foi clicado
...
function addToCart(name, price) {
    ...
    if(existingItem) {
        //Se o item já existe aumenta apenas a quantidade mais um 
    ...
    cart.forEach(item => {
        ...
        cartItemElement.innerHTML = `
            <div class = "flex items-center justify-between">
                ...
                <button class="removeItem" data-name="${item.name}">Remover</button>
...
//Pegar as informações de endereço (input)
